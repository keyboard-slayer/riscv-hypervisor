...
NPF_VISIBILITY int npf_snprintf(char *NPF_RESTRICT buffer, size_t bufsz, char const *NPF_RESTRICT format, ...) NPF_PRINTF_ATTR(3, 4);

NPF_VISIBILITY int npf_vsnprintf(char *NPF_RESTRICT buffer, size_t bufsz, char const *NPF_RESTRICT format, va_list vlist) NPF_PRINTF_ATTR(3, 0);

typedef void (*npf_putc)(int c, void *ctx);
NPF_VISIBILITY int npf_pprintf(npf_putc pc, void *NPF_RESTRICT pc_ctx, char const *NPF_RESTRICT format, ...) NPF_PRINTF_ATTR(3, 4);

NPF_VISIBILITY int npf_vpprintf(npf_putc pc, void *NPF_RESTRICT pc_ctx, char const *NPF_RESTRICT format, va_list vlist) NPF_PRINTF_ATTR(3, 0);
...
int npf_snprintf(char *NPF_RESTRICT buffer, size_t bufsz, char const *NPF_RESTRICT format, ...) {
    va_list val;
    va_start(val, format);
